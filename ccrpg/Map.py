...
class Darkness:
    ...
    boss = [1000000, 25000, 1500, 300, 2000, ["The Trident of Destruction", 10000], ["The Dark Ore Armor", 20000],
            "Galvador. The dark flame", 200, 1, 0, 0, 5]
...
# Tester weapons
sakaretsu_armour = [50, 30, 20, 0, "Sakaretsu armour", 8, 1, "Armour that increases offensive capability", 0, 0, 10, 0,
                    0]
simple_katana = [60, 0, 0, 0, "Katana", 8, 0, "In the right hands this weapon is as deadly as any blade", 0, 60, 0, 0,
                 0]
...
# the enemy arrays
enemy1 = [
    [10, 25, 15, 30, 20, ["The sword of darkness", 20], ["The armour of despair", 30], "Magnus, captain of despair", 20,
     1, 0, 0, 0],
...
necromancer_night_staff = [0, 1000, 0, 2000, "night staff", 4, 0, "a staff only for the best of necromancers", 0, 0, 0,
                           30, 0]
...
lancer_glaive = [300, 0, 300, 0, "the glaive", 6, 0, "a pole-arm designed to be slashed rather than thrusted", 1, 0, 60,
                 0, 0]
...
archer_greatbow = [600, 0, 0, 0, "greatbow", 7, 0,
                   "an extremely heavy bow that fires extremely heavy arrows that pack a huge punch", 1, 0, 60, 0, 0]
...
items2 = [warrior_spiked_armour, warrior_enchanted_armour, warrior_stone_armour, warrior_simple_armour,
          warrior_old_iron_armour, mage_magic_armour, mage_power_armour, mage_dex_armour, mage_oneshotarmour,
          mage_chaos_armour, paladin_grace_armour, paladin_blessed_armour, paladin_the_wall, paladin_steel_armour,
          paladin_shield_armour, necromancer_dark_cloak, necromancer_wraith_armour, necromancer_black_armour,
          necromancer_black_steel_armour, necromancer_ghost_armour, barbarian_endurance_armour, barbarian_flame_armour,
          barbarian_hard_leather_armour, barbarian_white_steel_armour, barbarian_brass_armour, lancer_speed_armour,
          lancer_protection_armour, lancer_woven_armour, lancer_ice_armour, lancer_white_iron_armour,
          archer_frost_armour, archer_agility_armour, archer_ash_armour, archer_frost_armour,
          archer_black_leather_armour, samurai_daredevil_armour, samurai_sakaretsu_armour, samurai_emperor_armour,
          samurai_ronin_armour, samurai_ebon_armour, samurai_blue_armour, samurai_orange_armour, samurai_green_armour]
items3 = [samurai_yellow_armour, samurai_red_armour, samurai_battle_worn_armour, ninja_light_kyu_gi, ninja_heavy_kyu_gi,
          ninja_light_dan_gi, ninja_heavy_dan_gi, ninja_darkness_armour, ninja_cloth_armour, warrior_cleaver,
          warrior_voltsword, warrior_balanced_sword, warrior_goddess_sword, warrior_sword_of_winds,
          warrior_sword_of_ages, warrior_silver_sword, mage_weaving_wand, mage_dragon_wand, mage_serpent_wand,
          mage_one_shot_wand, mage_blue_wand, mage_corrupted_wand, mage_apocalypse_wand, paladin_light_hammer,
          paladin_lightbringer, paladin_hammer_of_dawn, paladin_holy_axe, paladin_life_hammer, paladin_heavy_hammer,
          paladin_hammer_of_judgement, necromancer_dark_shield, necromancer_shadow_blade, necromancer_crystal_ball,
          necromancer_black_staff, necromancer_dimension_blade, necromancer_bone_staff, necromancer_night_staff,
          barbarian_dragon_sword, barbarian_bloodaxe, barbarian_battle_axe, barbarian_twin_axe, barbarian_hammer,
          barbarian_dragon_blade, barbarian_hatchets, lancer_trident, lancer_glaive]
items4 = [lancer_spear, lancer_sting, lancer_conquest_lance, lancer_war_lance, lancer_famine_lance, lancer_death_lance,
          lancer_oni_lance, archer_crossbow, archer_strong_bow, archer_hunters_bow, archer_hermes_bow,
          archer_explosive_bow, archer_black_bow, archer_greatbow, archer_shotgun, samurai_dark_katana,
          samurai_light_katana, samurai_gold_katana, samurai_yari, samurai_wakizashi, samurai_naginata,
          samurai_aluminium_katana, ninja_jo_staff, ninja_bo_staff, ninja_extended_bo_staff, ninja_surikens,
          ninja_kunai, ninja_dagger, ninja_tashi]
items.extend(items2)
items.extend(items3)
items.extend(items4)
...
items_accsesorys = [berserkers_band, priest_band, Fire_gem_circlet, major_ring, ring_of_random_change,
                    ...
                    boss_shield, sleepy_stick, lol, necrotic_bone, mr_tiddles]  # add acsessorys to new array
                    ...
                    if instruction == "\\money":
                        ...
                        while loop < length:
                            if items[loop][5] == 0 or items[loop][5] == int(player_class):
                                message_display("Item " + str(loop) + " - " + items[loop][4] + " costs " + str(
                                    store[1][loop]) + " from obrb type " + str(store[2][loop]), 400, y, 16, WHITE)
                                y = y + 20
                            loop = loop + 1
                        ...
                        if check == "TRUE":
                            if int(to_buy) <= int(length):  # check number isnt too big
                                if items[int(to_buy)][5] == 0 or items[int(to_buy)][5] == int(player_class):
                                    screen.fill(BLACK)
                                    message_display("You have attempted to buy " + str(items[int(to_buy)][4]), 400, 20,
                                                    16, WHITE)
                                    pygame.display.flip()
                                    ...
                                    if store[2][int(to_buy)] == "S":
                                        ...
                                        if amount < 0:
                                            ...
                                            file.close()
                                            message_display(
                                                "You have sucssesfully bought " + str(items[int(to_buy)][4]), 400, 60,
                                                16, WHITE)
                                            pygame.display.flip()
